...
void main() {
  group('SiteItem Widget Tests', () {
    ...
    testWidgets('switch is disabled when site has errors and is disconnected',
    ...
    testWidgets('switch is enabled when site has errors but is connected',
        (WidgetTester tester) async {
      final site = createMockSite(
        connected: true,
        errors: ['Some error'],
